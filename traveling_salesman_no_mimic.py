...
plot_fitness_curve(x_axis=iterations, curve_rhc=fitns_rhc, curve_sa=fitns_sa, curve_ga=fitns_ga, curve_mim=fitns_ga, title='Fitness')
plt.savefig('Figs/tsp-fit-no-mimic')
plot_fitness_curve(x_axis=iterations, curve_rhc=times_rhc, curve_sa=times_sa, curve_ga=times_ga, curve_mim=times_ga, title='Timing')
plt.savefig('Figs/tsp-timing-no-mimic')